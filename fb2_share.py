...
def logo_menu():
 ...
 banner = f''' 
          \033[1;92m  _    _          _____  ______  _____ 
	 \033[1;91m  | |  | |   /\   |  __ \|  ____|/ ____|
	 \033[1;93m  | |__| |  /  \  | |__) | |__  | (___  
	 \033[1;96m  |  __  | / /\ \ |  _  /|  __|  \___ \ 
	 \033[1;92m  | |  | |/ ____ \| | \ \| |____ ____) |
	 \033[1;91m  |_|  |_/_/    \_\_|  \_\______|_____/
		  \033[1;92m{"HARESH IS BRND BRO😊"}
	       \033[1;91m["WELCOME TO HARESH WORLD🌍"]

\033[1;92m WELCOME TO  Hares Hossin's TOOLS:>   '''
 cetak(nel(banner,title=f'{P2} {H2}[ Brand BRO]',subtitle_align='left',padding=1,style='blue'))
	
###----------[ MENU LOGIN ]----------###	
def login():
	os.system("clear")
	cetak(nel(f'   {H2}        LOGIN COOKIES FIRST BRO\n\n      {H2}       [ GITHUB : Hares-788-Cayber]',title=f'{P2} {H2}[ {OT} WELCOME SIRðŸ’¥ {H2}]',width=54,padding=(1,4),style='blue'))
	...
	try:
		...
		for x in range(jumlah):
			...
			if "id" in post:
				...
				print(f'{P}\r   STARTðŸ’ž> {bas} SUCCESSFUL SHARING {H}{n}{P} POST {N} ',end='');sys.stdout.flush()
			else:
				print("\n")
